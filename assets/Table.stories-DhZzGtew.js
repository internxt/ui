import{j as e}from"./jsx-runtime-nJEeJLyR.js";import"./iframe-D6-1bMoH.js";import"./preload-helper-PPVm8Dsz.js";const i=({children:a,className:r,...s})=>e.jsx("div",{className:r,children:e.jsx("table",{className:"w-full",...s,children:a})}),d=({children:a,className:r,...s})=>e.jsx("thead",{className:r,...s,children:a}),c=({children:a,className:r,...s})=>e.jsx("tbody",{className:r,...s,children:a}),o=({children:a,className:r,onClick:s,...n})=>e.jsx("tr",{onClick:s,className:r,...n,children:a}),l=({children:a,className:r,isHeader:s=!1,onClick:n,...p})=>{const m=s?"th":"td";return e.jsx(m,{onClick:n,className:r,...p,children:a})};i.__docgenInfo={description:`Table component
