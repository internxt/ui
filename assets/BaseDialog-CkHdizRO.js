import{j as e}from"./jsx-runtime-CkxqCPlQ.js";import{R as f}from"./X-B8Py3cVj.js";const h=({isOpen:o,title:t,subTitle:s,dialogRounded:r,children:i,onClose:n,classes:a,panelClasses:l,titleClasses:d,closeClass:p,weightIcon:c,bgColor:u,dataTest:m,hideCloseButton:g})=>e.jsx("div",{"data-test":m,className:`${o?"flex":"hidden"} ${a||""} absolute bottom-0 left-0 right-0 top-0 z-50 bg-black/40`,children:e.jsxs("div",{className:`${l||""} absolute left-1/2 top-1/2 flex w-104 -translate-x-1/2
