import{j as e}from"./jsx-runtime-DEdD30eg.js";import{M as p}from"./Menu-Bvvh4aMA.js";const d=40,l=({item:n,menuItemsRef:t,menu:r,openedFromRightClick:o,posX:a,posY:i,isContextMenuCutOff:s,genericEnterKey:u,handleMenuClose:m})=>e.jsx("div",{className:"z-20 mt-0 flex flex-col rounded-lg bg-surface py-1.5 shadow-subtle-hard outline-none dark:bg-gray-5",style:o?{position:"absolute",left:a,top:i,zIndex:99}:{position:"absolute",right:20,[s?"bottom":"top"]:d,zIndex:9999},ref:t,children:e.jsx(p,{item:n,genericEnterKey:u,handleMenuClose:m,menu:r})});l.__docgenInfo={description:`Properties for \`ContextMenuProps<T>\`
