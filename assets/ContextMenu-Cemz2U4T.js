import{j as e}from"./jsx-runtime-DQ7wxIhe.js";import{M as d}from"./Menu-Bh2QmXu_.js";const l=40,c=({item:n,menuItemsRef:t,menu:r,openedFromRightClick:o,posX:i,posY:a,isContextMenuCutOff:s,isOpen:u,genericEnterKey:m,handleMenuClose:p})=>e.jsx("div",{className:"z-20 mt-0 flex flex-col rounded-lg bg-surface py-1.5 shadow-subtle-hard outline-none dark:bg-gray-5",style:o?{position:"absolute",left:i,top:a,zIndex:99}:{position:"absolute",right:20,[s?"bottom":"top"]:l,zIndex:9999},ref:t,children:e.jsx(d,{item:n,isOpen:u,genericEnterKey:m,handleMenuClose:p,menu:r})});c.__docgenInfo={description:`Properties for \`ContextMenuProps<T>\`
