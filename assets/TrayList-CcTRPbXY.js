import{j as e}from"./jsx-runtime-DQ7wxIhe.js";import{I as y}from"./InfiniteScroll-BR2m0wIa.js";import{M as t}from"./MessageCheapSkeleton-CqsKMJAP.js";import{M as g}from"./MessageCheap-pOQPEqXC.js";const f=({mails:n,selectedEmails:i=[],loading:s,checked:o,activeEmail:l,hasMoreItems:d=!1,emptyState:m,onMailSelected:p=()=>{},onLoadMore:c=()=>{}})=>{const u=e.jsx("div",{className:"flex flex-col",children:new Array(3).fill(0).map((r,a)=>e.jsx(t,{},a))});return e.jsx("div",{className:"flex flex-col w-[400px] min-w-[200px] max-w-[400px] h-full",children:e.jsx("div",{id:"tray-scroll-container",className:"overflow-y-auto w-full h-full min-h-0",children:s?e.jsx(e.Fragment,{children:new Array(8).fill(0).map((r,a)=>e.jsx("div",{className:"flex flex-col gap-2",children:e.jsx(t,{})},a))}):e.jsx(e.Fragment,{children:n.length===0?e.jsx(e.Fragment,{children:m}):e.jsx(y,{handleNextPage:c,hasMoreItems:d,loader:u,scrollableTarget:"tray-scroll-container",children:n.map(r=>e.jsx("div",{className:"flex items-center w-full flex-col",children:e.jsx(g,{email:r,active:l===r.id,selected:o||i.includes(r.id),onClick:p})},r.id))})})})})};f.__docgenInfo={description:`@param {TrayListProps} TrayListProps - Props for the TrayList component
