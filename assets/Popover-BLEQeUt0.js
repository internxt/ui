import{j as r}from"./jsx-runtime-o9qq2xiW.js";import{r as t}from"./iframe-C1-GEPpH.js";const b=({childrenButton:d,panel:l,className:m,classButton:g})=>{const[o,s]=t.useState(!1),n=t.useRef(null),[f,a]=t.useState(o),[h,i]=t.useState("opacity-0"),[v,c]=t.useState("scale-95"),y=()=>s(e=>!e),u=e=>{n.current&&!n.current.contains(e.target)&&p()},p=()=>{s(!1)};return t.useEffect(()=>{if(o){const e=setTimeout(()=>{i("opacity-100"),c("scale-100")},10);return a(!0),()=>clearTimeout(e)}else{i("opacity-0"),c("scale-95");const e=setTimeout(()=>{a(!1)},100);return()=>clearTimeout(e)}},[o]),t.useEffect(()=>(document.addEventListener("mousedown",u),()=>{document.removeEventListener("mousedown",u)}),[]),r.jsxs("div",{style:{lineHeight:0},className:`relative ${m}`,children:[r.jsx("button",{onClick:y,className:`cursor-pointer outline-none ${g}`,"aria-expanded":o,"data-testid":"popover-button",children:d}),f&&r.jsx("div",{ref:n,className:`absolute right-0 z-50 mt-1 origin-top-right transform rounded-md border border-gray-10 bg-surface py-1.5 shadow-subtle duration-100 ease-out dark:bg-gray-5 ${h} ${v}`,children:l(p)})]})};b.__docgenInfo={description:`Popover component
