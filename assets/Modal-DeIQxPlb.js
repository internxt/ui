import{j as a}from"./jsx-runtime-C89ddIqy.js";import{r as o}from"./iframe-CeiX8cuE.js";const T=({isOpen:t,onClose:r,children:f,maxWidth:h,className:y,width:g,preventClosing:s=!1,stopMouseDownPropagation:w=!1})=>{const i=o.useRef(null),[v,d]=o.useState(t),[l,c]=o.useState("opacity-0"),[p,u]=o.useState("scale-95"),m=()=>{const e=document.querySelectorAll("[data-modal]"),n=e[e.length-1];i.current===n&&r()},x=e=>{w&&e.stopPropagation()};return o.useEffect(()=>{if(t){const e=setTimeout(()=>{c("opacity-100"),u("scale-100")},10);return d(!0),()=>clearTimeout(e)}else{c("opacity-0"),u("scale-95");const e=setTimeout(()=>{d(!1)},150);return()=>clearTimeout(e)}},[t]),o.useEffect(()=>{const e=n=>{i.current&&!i.current.contains(n.target)&&!s&&(n.preventDefault(),m())};return t&&document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e)}},[t,r,s]),o.useEffect(()=>{const e=n=>{n.key==="Escape"&&!s&&(n.preventDefault(),m())};return t&&window.addEventListener("keydown",e),()=>{window.removeEventListener("keydown",e)}},[t,r,s]),a.jsx(a.Fragment,{children:v&&a.jsxs("div",{className:"m-0",onMouseDown:x,role:"dialog","aria-modal":"true",children:[a.jsx("div",{className:`
              fixed
              min-h-full
              inset-0
              z-[9999]
            ...
            `}),a.jsx("div",{className:`
              ...
              ${l}
              ${p}
            `,children:a.jsx("section",{"data-testid":"ModalContent",ref:i,"data-modal":!0,className:`
                ${g??"w-full"}
                ${h??"max-w-lg"}
                ${y??"p-5"}
                text-gray-100
                ...
                ${l}
                ${p}
              `,children:f})})]})})};T.__docgenInfo={description:`Modal component
