import{j as s}from"./jsx-runtime-DQ7wxIhe.js";const o=({children:e,className:t="",id:n,dataCy:r})=>s.jsx("div",{id:n,"data-cy":r,className:`grid min-w-full auto-rows-min grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 ${t}`,children:e});o.__docgenInfo={description:`Grid component
...
@returns {JSX.Element}
- A JSX element containing the children formatted inside a grid.`,methods:[],displayName:"Grid",props:{className:{defaultValue:{value:"''",computed:!1},required:!1}}};export{o as G};
