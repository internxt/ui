import{I as i}from"./Input-g0SIY1q6.js";import"./jsx-runtime-C89ddIqy.js";import"./iframe-CeiX8cuE.js";import"./preload-helper-PPVm8Dsz.js";import"./IconBase.es-ySa3pMSe.js";import"./Warning.es-AUONRyYt.js";import"./X.es-DREZHKIl.js";const{useState:d}=__STORYBOOK_MODULE_PREVIEW_API__,m=(u,a)=>{const[l,p]=d(a.args.value),g=c=>{l!==c&&(p(c),a.updateArgs?.({value:c}))};return u({...a,args:{...a.args,value:l,onChange:g}})},T={title:"Components/Input",component:i,parameters:{layout:"centered"},decorators:[m],tags:["autodocs"],argTypes:{onChange:{action:"changed"}}},e={args:{label:"Text Input",variant:"default",value:"",placeholder:"Type something...",maxLength:20}},r={args:{label:"Search Input",variant:"search",value:"",placeholder:"Search..."}},s={args:{label:"Password Input",variant:"password",value:"",placeholder:"Enter password..."}},n={args:{label:"Input with Success Message",variant:"default",value:"",message:"Your input is correct!",accent:"success"}},t={args:{label:"Input with Error Message",variant:"default",value:"",message:"There was an error!",accent:"error"}},o={args:{label:"Input with Warning Message",variant:"default",value:"",message:"This is a warning!",accent:"warning"}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Text Input',
    variant: 'default',
    value: '',
