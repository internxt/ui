import{I as L}from"./Input-DHafeKDC.js";import"./jsx-runtime-CkxqCPlQ.js";import"./index-DJO9vBfz.js";import"./IconBase-CGf_ViAl.js";import"./X-B8Py3cVj.js";const{useState:Y}=__STORYBOOK_MODULE_PREVIEW_API__,A=(O,a)=>{const[l,W]=Y(a.args.value),y=c=>{var u;l!==c&&(W(c),(u=a.updateArgs)==null||u.call(a,{value:c}))};return O({...a,args:{...a.args,value:l,onChange:y}})},U={title:"Components/Input",component:L,parameters:{layout:"centered"},decorators:[A],tags:["autodocs"],argTypes:{onChange:{action:"changed"}}},e={args:{label:"Text Input",variant:"default",value:"",placeholder:"Type something...",maxLength:20}},r={args:{label:"Search Input",variant:"search",value:"",placeholder:"Search..."}},s={args:{label:"Password Input",variant:"password",value:"",placeholder:"Enter password..."}},n={args:{label:"Input with Success Message",variant:"default",value:"",message:"Your input is correct!",accent:"success"}},t={args:{label:"Input with Error Message",variant:"default",value:"",message:"There was an error!",accent:"error"}},o={args:{label:"Input with Warning Message",variant:"default",value:"",message:"This is a warning!",accent:"warning"}};var p,g,i;e.parameters={...e.parameters,docs:{...(p=e.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    label: 'Text Input',
    variant: 'default',
    value: '',
